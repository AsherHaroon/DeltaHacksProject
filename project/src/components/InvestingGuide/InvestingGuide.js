...
const InvestingGuide = () => {
  return (
    <div>
      <h1 style={{ color: "#0050a5ff", fontSize: "60px", marginLeft: "24px"}}>How to Invest</h1>
      <div style={{ display: "flex", alignItems: "center" }}>
        <div style={{ color: "#ffdf01ff", fontSize: "20px", marginLeft: "24px"}}>
          <p>Sign Up</p>
          <p style={{ color: "grey" }}>Create a secure account on Rinvest</p>
        </div>
        <div style={{ color: "#ffdf01ff", fontSize: "20px", marginLeft: "36px"}}>
        ...
        <div style={{ color: "#ffdf01ff", fontSize: "20px", marginLeft: "36px", marginRight: "24px"  }}>
          <p>Hold or Sell</p>
